   ...
   <div class="col-sm-12">
      <div class="card">
         <div class="card-header d-flex justify-content-between">
            ...
            <a href="{{route('questions.create')}}" class="btn btn-info" style="float: right;"><i class="fa fa-plus"></i> Add New Question</a>
         </div>
         <div class="card-body">
