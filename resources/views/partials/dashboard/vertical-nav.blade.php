<ul class="navbar-nav iq-main-menu"  id="sidebar">
    ...
    <!-- Questions -->
    <li class="nav-item">
        <a class="nav-link" data-bs-toggle="collapse" href="#questions-menu" role="button" aria-expanded="false" aria-controls="questions-menu">
            <i class="icon">
                <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <ul class="sub-nav collapse" id="questions-menu" data-bs-parent="#sidebar">
            <li class="nav-item ">
                <a class="nav-link {{activeRoute(route('questions.index'))}}" href="{{route('questions.index')}}">
                  <i class="icon">
